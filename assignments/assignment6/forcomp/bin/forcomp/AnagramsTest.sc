...
dictionaryByOccurrences.contains(List(('e',1), ('i',1), ('l',1), ('r',1), ('t',2)))
  ...
  def wordAnagrams(word: Word): List[Word] = dictionaryByOccurrences(wordOccurrences(word))
   ...
   wordAnagrams("ate")                            //> res3: List[forcomp.AnagramsTest.Word] = List(ate, eat, tea)
...
def removeChar(charList1 : List[Char], charList2: List[Char]): List[Char]={
  ...
  val occur = wordOccurrences("asis")             //> occur  : forcomp.AnagramsTest.Occurrences = List((a,1), (i,1), (s,2))
 ...
 // List(List(('a',1), ('s',2)), List(('a',10))).contains(List(('a',10)))
  ...
  val  sentence = List("as","is")                 //> sentence  : List[String] = List(as, is)
  val senOccurs = sentenceOccurrences(sentence)   //> senOccurs  : forcomp.AnagramsTest.Occurrences = List((a,1), (i,1), (s,2))
  	GetSetenceAnagram(senOccurs).flatMap(x=>convertOccurrenceToString(x))
                                                  //> res7: List[forcomp.AnagramsTest.Sentence] = List(List(as, is), List(is, as)
                                                  //| )
  ...
  }                                               //> sentenceAnagrams: (sentence: forcomp.AnagramsTest.Sentence)List[forcomp.Ana
                                                  //| gramsTest.Sentence]
  sentenceAnagrams(List("as","is"))               //> res8: List[forcomp.AnagramsTest.Sentence] = List(List(as, is), List(is, as)
                                                  //| )
  
  sentenceAnagrams(List("Yes", "man"))            //> res9: List[forcomp.AnagramsTest.Sentence] = List(List(as, en, my), List(en,
                                                  //|  as, my), List(sane, my), List(Sean, my), List(man, yes), List(as, my, en),
                                                  //|  List(my, as, en), List(say, men), List(en, my, as), List(my, en, as), List
                                                  //| (men, say), List(yes, man), List(my, sane), List(my, Sean))
