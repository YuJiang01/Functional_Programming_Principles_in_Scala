...
class Empty extends TweetSet {
  ...
  def mostRetweeted = throw new java.util.NoSuchElementException("No mostRetweeted for Empty")
...
def filterAcc(p: Tweet => Boolean, acc: TweetSet): TweetSet = {
  ...
  def descendingByRetweet: TweetList = new Cons(mostRetweeted, remove(this.mostRetweeted).descendingByRetweet)
